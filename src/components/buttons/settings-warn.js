    ...
    if (args[0] === 'config') {
      ...
      if (warnConfigHandler) {
        ...
        await interaction.reply({
          content: '❌ Ошибка: не удалось найти обработчик конфигурации предупреждений.',
          flags: MessageFlags.Ephemeral
        });
      }
      ...
      if (editRuleHandler) {
        ...
        await interaction.reply({
          content: '❌ Ошибка: не удалось найти обработчик редактирования правила.',
          flags: MessageFlags.Ephemeral
        });
      }
    } else {
      ...
      if (settingsHandler) {
        ...
        await interaction.reply({
          content: '⚙️ Настройки предупреждений.',
          flags: MessageFlags.Ephemeral
        });
      }
    }
