...
module.exports = {
  customId: "settings:reason-edit-modal",
  ...
  async execute(interaction, args, client) {
    ...
    try {
      ...
      await svc.updateReason(guildId, id, { label, description: description || undefined });
      ...
      client.logs?.error?.(`Edit reason error: ${e.message}`);
